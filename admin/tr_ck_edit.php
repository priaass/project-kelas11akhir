...
<body>
    <div class="box">
        ...
        <?php
        $id = $_GET['id'];
        $query = mysqli_query($koneksi, "SELECT * FROM tr_cuci_komplit WHERE id = $id");
        while($data=mysqli_fetch_array($query)){
        ?>
        <form class="cont" action="tr_ck_update.php" method="post">
            ...
            <div class="input">
                ...
                <div class="inputan">
                    ...
                    <select name="paket_id" required>
                        ...
                        <option value="1" <?php if($data['paket_id'] == 1) echo 'selected'; ?>>Cuci Komplit Reguler</option>
                        <option value="2" <?php if($data['paket_id'] == 2) echo 'selected'; ?>>Cuci Komplit Kilat</option>
                        <option value="3" <?php if($data['paket_id'] == 3) echo 'selected'; ?>>Cuci Komplit Express</option>
                    </select>
                </div>
                <div class="inputan">
                <label>Status</label>
